...
@Builder
@Schema(
        description = "Datos de cementerio devueltos en respuestas",
        example = "{\n" +
                "  \"id\": 1,\n" +
...
public class CementerioResponse {
     ...
     */
    @Schema(
            description = "Identificador único del cementerio",
            example = "1",
            required = true
    )
    private Integer id;
     ...
     */
    @Schema(
            description = "Código postal del cementerio",
            example = "23001",
            required = false
    )
     ...
     */
    @Schema(
            description = "Coordenada X (Longitud) WGS84",
            example = "-3.78945678",
            required = false
    )
     ...
     */
    @Schema(
            description = "Coordenada Y (Latitud) WGS84",
            example = "37.77945678",
            required = false
    )
