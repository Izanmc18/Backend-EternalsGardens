...
@AllArgsConstructor
@Builder
@Schema(description = "Datos de usuario devueltos en respuestas del servidor", example = "{\n" +
                "  \"id\": 1,\n" +
                "  \"nombre\": \"Juan\",\n" +
...
public class UsuarioResponse {
         ...
         */
        @Schema(description = "Identificador único del usuario (generado por BD)", example = "1", required = true)
        private Integer id;
         ...
         */
        @Schema(description = "Nombre completo del usuario", example = "Juan", required = true)
         ...
         */
        @Schema(description = "Apellidos completos del usuario", example = "García López", required = true)
         ...
         */
        @Schema(description = "DNI del usuario", example = "12345678Z", required = true)
        private String dni;
         ...
         */
        @Schema(description = "Email del usuario (usado para login)", example = "juan.garcia@email.com", required = true)
         ...
         */
        @Schema(description = "Teléfono móvil del usuario", example = "612345678", required = true)
         ...
         */
        @Schema(description = "Fecha de nacimiento del usuario", example = "1985-03-15", type = "string", format = "date", required = true)
         ...
         */
        @Schema(description = "Nombre del rol en texto (ej: ADMINISTRADOR, OPERADOR, USUARIO)", example = "ADMINISTRADOR", required = true)
         ...
         */
        @Schema(description = "Estado de activación (true=activo, false=inactivo)", example = "true", required = true, type = "boolean")
         ...
         */
        @Schema(description = "Fecha y hora de creación de la cuenta", example = "2026-01-22T07:30:00", type = "string", format = "date-time", required = false)
         ...
         * - Cambio de rol
         */
        @Schema(description = "Fecha y hora de la última modificación", example = "2026-01-22T10:45:30", type = "string", format = "date-time")
        private LocalDateTime fechaUltimaModificacion;

        @Schema(description = "ID del cementerio asignado (si aplica)", example = "1")
        private Integer cementerioId;

        @Schema(description = "Nombre del cementerio asignado (si aplica)", example = "Cementerio Central")
