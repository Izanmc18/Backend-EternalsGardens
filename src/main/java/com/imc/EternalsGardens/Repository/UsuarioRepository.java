 ...
 *
 * Proporciona métodos para buscar usuarios por email, DNI, nombre y otros
 * criterios
 * necesarios para autenticación, gestión de cuentas y operaciones
 * administrativas.
 *
...
public interface UsuarioRepository extends JpaRepository<Usuario, Integer> {
        ...
        /**
         * Obtiene una página de usuarios cuyo rol contiene el texto especificado.
         *
         * @param rol      nombre del rol (parcial)
         * @param pageable información de paginación
         * @return página de usuarios
         */
        org.springframework.data.domain.Page<Usuario> findByRolNombreContainingIgnoreCase(String rol,
                        org.springframework.data.domain.Pageable pageable);

        @Query("SELECT u FROM Usuario u WHERE u.cementerio.id = :cementerioId AND u.rol.nombre = :rolNombre")
        List<Usuario> findByCementerioIdAndRolNombre(@Param("cementerioId") Integer cementerioId,
